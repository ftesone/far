...
foldConsulta :: (String -> Consulta) -> (TablaBase -> Consulta) -> (Predicado -> Consulta -> Consulta) -> ([Columna] -> Consulta -> Consulta) -> (Consulta -> Consulta -> Consulta) -> (Consulta -> Consulta -> Consulta) -> (Consulta -> Consulta -> Consulta) -> (Consulta -> Consulta -> Consulta) -> (Consulta -> Consulta -> Consulta) -> Consulta -> Consulta
foldConsulta fa ft fs fp fx fn fu fi fd (Taux t)    = fa t
foldConsulta fa ft fs fp fx fn fu fi fd (Tau t)     = ft t
foldConsulta fa ft fs fp fx fn fu fi fd (Sigma p q) = fs p (foldConsulta fa ft fs fp fx fn fu fi fd q)
foldConsulta fa ft fs fp fx fn fu fi fd (Pi cs q)   = fp cs (foldConsulta fa ft fs fp fx fn fu fi fd q)
foldConsulta fa ft fs fp fx fn fu fi fd (X q1 q2)   = fx (foldConsulta fa ft fs fp fx fn fu fi fd q1) (foldConsulta fa ft fs fp fx fn fu fi fd q2)
foldConsulta fa ft fs fp fx fn fu fi fd (NX q1 q2)  = fn (foldConsulta fa ft fs fp fx fn fu fi fd q1) (foldConsulta fa ft fs fp fx fn fu fi fd q2)
foldConsulta fa ft fs fp fx fn fu fi fd (U q1 q2)   = fu (foldConsulta fa ft fs fp fx fn fu fi fd q1) (foldConsulta fa ft fs fp fx fn fu fi fd q2)
foldConsulta fa ft fs fp fx fn fu fi fd (I q1 q2)   = fi (foldConsulta fa ft fs fp fx fn fu fi fd q1) (foldConsulta fa ft fs fp fx fn fu fi fd q2)
foldConsulta fa ft fs fp fx fn fu fi fd (D q1 q2)   = fd (foldConsulta fa ft fs fp fx fn fu fi fd q1) (foldConsulta fa ft fs fp fx fn fu fi fd q2)
